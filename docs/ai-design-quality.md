...
| Hạng mục | Thay đổi |
|---|---|
| Workflow | `system-prompt.md`: thêm phân loại artboard đơn / trang nhiều section; thêm **Direct workflow** render nội dung thật trực tiếp (bỏ skeleton-first cho artboard đơn) |
| Cổng hoàn thành | `system-prompt.md`: mục "Completion check" — cấm kết thúc khi còn placeholder/text rỗng |
