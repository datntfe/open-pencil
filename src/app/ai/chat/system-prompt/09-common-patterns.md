...
- **Comparison** — Use for before/after, plan A/B, pros/cons. Priority: Layout Architect + Information Designer + Typographer. Paired columns with matching row structure. Risk: mismatched content density.
...
- **Infographic board** — Use for educational/social explainers. Priority: Information Designer + Icon Director + Layout Architect. Modular cards, consistent icons, strong grouping. Risk: text overload.
